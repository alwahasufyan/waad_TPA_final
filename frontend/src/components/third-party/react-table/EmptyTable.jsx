      ...
      <svg width="120" height="100" viewBox="0 0 184 152" aria-hidden focusable="false">
        <g fill="none" fillRule="evenodd">
          <g transform="translate(24 31.67)">
            <ellipse fill={isDarkMode ? grey400 : grey200} filter="brightness(0.9)" cx="67.797" cy="106.89" rx="67.797" ry="12.668" />
            <path
          ...
          />
          <g fill={isDarkMode ? grey400 : grey200} filter="brightness(0.9)" transform="translate(149.65 15.383)">
