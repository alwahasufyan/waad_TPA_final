...
public class ProviderSettlementReportDto {
    ...
    /**
     * صافي المستحق لمقدم الخدمة (قبل خصم العقد)
    ...
    /**
     * نسبة خصم العقد (%)
     * Contract discount percentage from active provider contract
     */
    private BigDecimal contractDiscountPercent;

    /**
     * مبلغ خصم العقد
     * Contract discount amount = netProviderAmount × (discountPercent / 100)
     */
    private BigDecimal contractDiscountAmount;

    /**
     * صافي المستحق الفعلي لمقدم الخدمة (بعد خصم العقد)
     * Actual provider share = netProviderAmount - contractDiscountAmount
     * This matches what is actually credited to the provider's account.
     */
    private BigDecimal actualProviderShare;
