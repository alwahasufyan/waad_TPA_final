...
public class UnifiedMemberController {
         ...
         */
        @PostMapping
        @PreAuthorize("hasAnyRole('SUPER_ADMIN', 'WAAD_ADMIN', 'EMPLOYER_ADMIN')")
         ...
         */
        @GetMapping
        @PreAuthorize("hasAnyRole('SUPER_ADMIN', 'WAAD_ADMIN', 'EMPLOYER_ADMIN', 'MEDICAL_REVIEWER')")
        ...
        public ResponseEntity<byte[]> downloadBeneficiariesPdf(
                ...
                log.info("Generating PDF report for members: orgId={}, status={}, type={}", organizationId, status,
                                type);
                ...
                data.put("activeMembers",
                                members.stream().filter(
                                                m -> (m.getStatus() != null && "ACTIVE".equals(m.getStatus().name())) ||
                                                                (m.getCardStatus() != null && "ACTIVE"
                                                                                .equals(m.getCardStatus().name())))
                                                .count());

                long familiesCount = members.stream()
                                .filter(m -> m.getType() != null && "PRINCIPAL".equals(m.getType()))
                                .count();
        ...
        @PreAuthorize("hasAnyRole('SUPER_ADMIN', 'WAAD_ADMIN', 'DATA_ENTRY', 'EMPLOYER_ADMIN', 'PROVIDER_STAFF', 'MEDICAL_REVIEWER')")
        ...
        @PreAuthorize("hasAnyRole('SUPER_ADMIN', 'WAAD_ADMIN', 'DATA_ENTRY', 'EMPLOYER_ADMIN', 'MEDICAL_REVIEWER')")
        ...
        @PreAuthorize("hasAnyRole('SUPER_ADMIN', 'WAAD_ADMIN', 'DATA_ENTRY', 'EMPLOYER_ADMIN')")
